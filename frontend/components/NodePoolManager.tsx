...
const NodePoolManager: React.FC = () => {
  ...
  return (
    <div className="w-full mx-auto">
      {/* TODO: delete the following div */}
      <div className="hidden bg-slate-800/50 rounded-lg p-4 border border-slate-700/50">
      ...
      <CyberPoolPanel title="Pools Manager" variant="cyan">
        <div className="flex justify-between mb-2">
          ...
          <span className="text-sm font-bold">
            {nodes.length} {nodes.length == 0 ? "Nodes" : ""}
          </span>
        </div>
        <div className="grid grid-cols-1 gap-4">
          ...
          {nodes.length === 0 && (
            <div className="col-span-full text-center py-12 bg-slate-800/30 rounded-lg border border-dashed border-slate-700/50">
