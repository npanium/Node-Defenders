    ...
    extend: {
      colors: {
        ...
        neon: {
          ...
          purple: "#FF00FF", // Bright magenta/purple
          green: "#00FF00", // Bright green
          yellow: "#FFFF00", // Bright yellow
          pink: "#FF6EFF", // Bright pink
        },
        cyber: {
          black: "#0D0221", // Deep space black
          darkblue: "#0F1F3D", // Dark blue
          blue: "#2A26A8", // Medium blue
          purple: "#42275A", // Deep purple
        },
      ...
      // Animation for glowing and pulsing effects
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
